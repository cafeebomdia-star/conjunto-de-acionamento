...
const App: React.FC = () => {
  ...
  if (loading) return <div className="flex items-center justify-center h-screen bg-gray-100"><div className="spinner"></div></div>;
  ...
  return <div className="max-w-md mx-auto min-h-screen bg-white shadow-xl">{renderView()}</div>;
};
